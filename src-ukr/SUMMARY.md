...
- [Звичайні колекції](ch08-00-common-collections.md)
    ...
    - [Зберігання ключів і пов'язаних значень у хешмапах](ch08-03-hash-maps.md)
...
- [Об'єктно орієнтовані особливості Rust](ch17-00-oop.md)
    - [Характеристики об'єктно орієнтованого програмування](ch17-01-what-is-oo.md)
    - [Використання трейтових об'єктів, які допускають значення різних типів](ch17-02-trait-objects.md)
    - [Реалізація патернів об'єктноорієнтованого програмування](ch17-03-oo-design-patterns.md)
